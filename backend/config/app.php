...
return [
    ...
    'App' => [
        ...
        'jsBaseUrl' => 'js/',
        /*
         * Origins allowed to call the API cross-origin (the deployed SPA).
         * Set CORS_ORIGINS as a comma-separated list, e.g.
         * "https://stayvanta.pages.dev,https://app.stayvanta.com".
         * Read by App\Middleware\CorsMiddleware. In debug mode all origins
         * are reflected, so this only matters in production.
         */
    ...
    'Datasources' => [
        ...
        'default' => [
            ...
            /*
             * Connection params come from the environment so the same image
             * runs everywhere. On Railway, set DATABASE_URL to the MySQL DSN
             * (it takes precedence); otherwise the discrete DB_* vars are used.
             * Locally these are overridden by config/app_local.php.
             */
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', ''),
            'database' => env('DB_DATABASE', 'stay_vanta'),
